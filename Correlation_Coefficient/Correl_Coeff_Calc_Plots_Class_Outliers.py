...
class Correlation_Outliers(object):
    ...
    def __init__(self, x_type, y_type, left_or_right):
        ...
        # Call the function to divide all cells into 3 groups;
        # fast-dividers (left), slow-dividers (right), normal-dividers (middle):

        self.outliers = ShortlistOutliers(left_or_right=self.left_or_right)
        print("{} Outliers: {}".format(left_or_right, self.outliers))
