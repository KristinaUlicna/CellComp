...
for number in [60]:
    #call_template.SegClass(BF=True, GFP=True, RFP=True, ResNet=False)
    call_template.Tracking(to_track_GFP=True, to_track_RFP=True, config_number="", timeout_seconds=1800)
