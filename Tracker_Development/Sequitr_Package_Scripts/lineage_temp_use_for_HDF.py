...
class LineageTreePlotter(object):
    ...
    def plot(self, tree):
        ...
        queue, marked, y_pos = [], [], []
        print ("queue, marked, y_pos: {}, {}, {}".format(queue, marked, y_pos))
        ...
        while len(queue) > 0:
            ...
            print("line_list, marker_list, text_list: {}, {}, {}".format(line_list, marker_list, text_list))
